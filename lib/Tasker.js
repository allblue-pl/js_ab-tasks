...
import Task, { TaskCall, TaskInfo } from "./Task.js";
export default class Tasker {
    ...
    #addWaitingTask(task, args, lastCall) {
    ...
    #isTaskInfoReadyToExec(taskInfo) {
    ...
    #processWaitingTasks() {
        ...
        if (Object.keys(this.#taskInfos_Waiting).length > 0 &&
            ...
            this.#processCalls === 0) {
            console.warn('Unexecuted tasks in waiting queue:', Object.keys(this.#taskInfos_Waiting));
        }
    }
    #waitForToRegExp(str) {
